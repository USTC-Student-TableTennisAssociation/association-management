...
export function ViewCommandProposalCard({ proposal }: { proposal: ViewCommandProposalNotice }) {
  ...
  return (
    <div className="mt-3 rounded-lg border border-amber-200 bg-amber-50 p-3 text-xs text-amber-950">
      ...
      <p className="mt-1">{proposal.viewKey} · expected state {proposal.stateVersion}</p>
