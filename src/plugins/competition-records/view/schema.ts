...
export const competitionRecordsViewModule: ViewModule = {
  manifest: {
    ...
    aiSemanticInstructions: [
      ...
      "Edition 是来源事实的只读镜像，只能由 competition.sync_editions 从权威来源写入；发现日期、名称或参与人数错误时，应修正来源后重新同步，不得由人或 AI 直接修改。",
      "同步时使用权威来源的参与人数和 source_id，不从赛果数量猜测参与人数；同一 source_system/source_id 只能对应一张 Edition Card。",
