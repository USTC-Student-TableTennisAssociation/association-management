...
- `sydaris.activity-operations.design-playbook`：从 Shared Brain 与原始资料整理有来源的组织方法，只允许 Playbook Command；
- `sydaris.activity-operations.plan-task-map`：规划或检查真实 Activity 的执行版图，不允许改写 Playbook。
