...
区分系统/平台、审批/流程、活动实例、活动类别、角色、人物、制度和文档。例如“二课系统”与
“二课审批”高度相关但通常不是同一身份。

对人物身份采取保守的证据门槛：姓名相同、去掉“学长/老师/会长”等称谓后相同、同属一个
组织，或时间与履历在叙事上相容，都只能用于召回候选，不能单独证明是同一人。只有原文明示的
别名或脚注映射、学号等唯一稳定标识，或其他能够排除同名歧义的直接证据，才足以 attach。如果结论
仍依赖“可能”“很可能”“符合背景”等合理性推测，必须 create。称谓不同本身不禁止 attach：例如
“钟会长¹”的脚注明确写明“钟轹弘，24-25级乒协会长”时，可以与“钟轹弘” attach；但仅有
“刘畅”和“刘畅学长”且没有这类直接映射时，必须保留为不同人物。
