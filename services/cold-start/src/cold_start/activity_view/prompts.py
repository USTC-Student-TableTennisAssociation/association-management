...
- `system`：二课、Notion 等被持续操作或依赖的制度化系统；
- `funding_scheme`：星级经费、专项补贴等经费来源或安排；
...
活动的时间、规模、对象和赛制通常作为关于 Activity 的 Assertion，不要制造“秋季活动”或
...
不要用“它处于更大流程内部”作为选择 `work_step` 的理由。报销、体育场馆申请、行政审批
...
检查必要的时期约束是否缺失；排除协会通史、荣誉、个人经历、一般治理问题、价值叙事和
